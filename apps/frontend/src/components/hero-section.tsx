            ...
            <div className="flex flex-col md:flex-row h-screen">
                <div className="w-full md:w-1/2 flex items-center justify-center h-screen">
                    <div className="text-center space-y-4 mx-4">
                        <h2 className="text-5xl md:text-6xl font-bold">OFFICE HOURS<br></br>MADE EASY</h2>
                        <h3 className="text-xl md:text-2xl font-semibold">one import. automatic updates.</h3>
